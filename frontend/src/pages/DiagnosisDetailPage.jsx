        ...
        <div className="min-h-screen pb-12">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2 font-vietnam tracking-tight">Chi Tiết Chẩn Đoán</h1>
                    <p className="text-gray-500 font-medium tracking-wide">Thông tin chi tiết về lần chẩn đoán bệnh cây trồng</p>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div className="aspect-video bg-gray-50 relative">
                                ...
                                <div className="absolute top-4 left-4 bg-agri-dark/80 backdrop-blur px-3 py-1 rounded-full">
                                    <span className="text-white text-[10px] font-bold uppercase tracking-widest">Hình ảnh chẩn đoán</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                            <div className="flex items-center justify-between mb-8">
                                <h2 className="text-3xl font-bold text-agri-dark">{diagnosis.disease_name}</h2>
                                <span className={`px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider ${
                                    diagnosis.is_healthy 
                                        ? 'bg-green-100 text-green-800' 
                                        : 'bg-red-100 text-red-800'
                                }`}>
                                    {diagnosis.is_healthy ? 'Lành mạnh' : 'Phát hiện bệnh'}
                                </span>
                            </div>

                            <div className="mb-8">
                                <div className="flex items-center gap-3 mb-2">
                                    <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Độ tin cậy AI:</span>
                            ...
                            <div className="mb-8">
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                                    <AlertCircle className="w-3 h-3 text-agri-green" /> Mô tả bệnh lý
                                </h3>
                            ...
                            <div>
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Dấu hiệu nhận biết</h3>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-5 flex items-center gap-2">
                                <Clock className="w-3 h-3" /> Thông tin lưu trữ
                            </h3>
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Thời gian lưu</p>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Người chẩn đoán</p>
                                        <p className="text-xs font-bold text-agri-dark">{user?.name || 'Người dùng ẩn danh'}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Phân loại</p>
                                        <p className="text-xs font-bold text-agri-dark">
                                            {diagnosis.is_healthy ? 'Cây khỏe mạnh' : 'Cần can thiệp'}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6 flex items-center gap-2">
                                <Leaf className="w-3 h-3 text-agri-green" /> Phác đồ khuyến nghị
                            </h3>
                            <div className="space-y-6">
                                {diagnosis.treatments && diagnosis.treatments.length > 0 ? (
                                    ...
                                    <div key={index} className="relative pl-6 pb-6 border-l-2 border-gray-100 last:pb-0">
                                        ...
                                        <h4 className="text-sm font-bold text-agri-dark mb-3">
                                            {treatment.level || treatment.severity || 'Bước'} - {treatment.name || treatment.action || 'Xử lý'}
                                        </h4>
                                        <div className="space-y-3">
                                            ...
                                            {treatment.product && (
                                                <div className="bg-green-50 border border-green-100 rounded-xl p-3">
                                                    <p className="text-[10px] font-black text-green-800 uppercase mb-1">Sản phẩm khuyến dùng:</p>
                                            ...
                                            {treatment.action && (
                                                <div className="bg-blue-50 border border-blue-100 rounded-xl p-3">
                                                    <p className="text-[10px] font-black text-blue-800 uppercase mb-1">Hướng dẫn thực hiện:</p>
                                    ...
                                    <div className="text-center py-4">
                                        <p className="text-gray-400 text-xs italic">Không có phác đồ điều trị bổ sung</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="p-5 bg-amber-50 rounded-2xl border border-amber-100">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[10px] font-bold text-amber-800 uppercase tracking-wider">Lưu ý chuyên môn</span>
                            </div>
                            <p className="text-[10px] text-amber-900/60 leading-relaxed">
                                Kết quả được lưu trữ từ phiên làm việc trước đó. Tình trạng bệnh có thể đã thay đổi theo thời gian.
                            </p>
                        </div>
                    </div>
                </div>
