// Product mapping database for direct e-commerce links (Mobile version)
...
const productMapping = {
  ...
  "Benlat": {
    shopee: "https://shopee.vn/search?keyword=Benlat&category=100030&subcategory=100031",
...
// Function to get Shopee app deep link with agricultural category
export const getShopeeAppLink = (productName) => {
  // Use search with agricultural category for better results
